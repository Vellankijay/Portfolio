...
export const Timeline = ({
  ...
  return (
    <div
      className="min-h-screen mt-20 md:mt-30"
      ref={containerRef}>
      <h2 className="text-heading text-yellow-600 animate-pulse pl-20">
        My Work Experience
      </h2>
        ...
        {data.map((item, index) => (
          <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
            <div
              ...
              <div className="flex-col hidden gap-2 text-xl font-bold md:flex md:text-4xl text-neutral-300 hover:text-yellow-500 transition-colors duration-500 pl-20">
                <h3>{item.date}</h3>
